...
cp -r yuanbao ~/.hermes/skills/yuanbao/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/yuanbao-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/yuanbao-skill.git ~/.hermes/skills/yuanbao/
```
...
```text
Use the yuanbao skill to <describe your specific task here>
```
...
```text
Gunakan skill yuanbao untuk <deskripsikan tugas spesifik Anda di sini>
```
